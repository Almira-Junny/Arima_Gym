            ...
            >
              ...
              <Box sx={{ mb: 4, width: { xs: "100%", md: "70%" } }}>
                <Typography sx={{ color: "text.secondary", lineHeight: 1.6 }}>
                  {
                    "Bạn muốn tìm kiếm một phòng tập rộng rãi, đầy đủ máy móc hiện đại, huấn luyện viên nhiệt tình ? Hãy đến với Arima Gym"
                  }
                </Typography>
              </Box>
              <Box sx={{ "& button": { mr: 2 } }}>
          ...
          <Grid item xs={12} md={5} sx={{ position: "relative" }}>
            ...
            >
              ...
              <Box>
                ...
                >
                  Phòng tập có chứng nhận đạt tiêu chuẩn quốc tế
                </Typography>
              </Box>
            </Box>
            <Box sx={{ lineHeight: 0 }}>
