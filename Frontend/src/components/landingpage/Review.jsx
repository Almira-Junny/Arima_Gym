      ...
      <Container>
        <Grid container spacing={3}>
          <Grid item xs={12} md={7}>
            ...
            >
              Trong hơn 5 năm qua, hơn 100000 người đã chọn chúng tôi để bắt đầu
              hành trình tập luyện và thay đổi bản thân
            </Typography>
            <Typography
              sx={{ color: "text.secondary", mb: 2, ml: { xs: 0, md: 4 } }}
            >
              Bên cạnh là hình ảnh của hội viên Lê Thị Kim Mỹ - Chiến thắng bản
              thân là chiến thắng hiển hách nhất
            </Typography>
          </Grid>
