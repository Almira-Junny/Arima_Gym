...
import { getAllUsers, getUserByNumber } from "../api/user";
...
function Payments() {
  ...
  const { data: allUsers, isLoading } = useQuery("all-users", getAllUsers, {
  ...
  // const { data: searchUsers, isLoading: isSearching } = useQuery(
  //   "search-users",
  //   getAllUsers,
  //   {
  //     refetchOnWindowFocus: false,
  ...
  const onKeyDown = async (e) => {
    if (e.key === "Enter") {
      if (e.target.value.trim() === "") {
        ...
        setIsSearching(true);
        const data = await getUserByNumber(e.target.value);
        setData(data);
